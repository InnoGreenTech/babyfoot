...
String page =F("body{display: flex;flex-direction: row;font-family: Arial,sans-serif;color: rgb(72,11,08);}");
       ...
       page +=F(".rouge{ width:100px;height:25px;background:#069;background-color: rgb(255,0,0);border-radius: 10px;box-shadow: 6PX 6PX 6PX silver;}");
       page +=F(".bleu{ width:100px;height:25px;background:#069;background-color: rgb(0,0,255);border-radius: 10px;box-shadow: 6PX 6PX 6PX silver;}");
       page +=F(".blanc{ width:100px;height:25px;background:#069;background-color: rgb(255,255,255);border-radius: 10px;box-shadow: 6PX 6PX 6PX silver;}");
       page +=F(".inconnu{ width:100px;height:25px;background:#069;background-color: rgb(100,100,100);border-radius: 10px;box-shadow: 6PX 6PX 6PX silver;}");
